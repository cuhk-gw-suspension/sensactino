...
setup(
    name='sensactino',  # Required
    version=VERSION,  # Required
    description='send command to arduino to control stepper motion',  # Optional
    ...
    packages=find_packages(include=["sensactino*",]),
